...
var bouton1 = document.getElementById("firstLine");
bouton1.addEventListener("click",NewFirstLine);
bouton1.addEventListener("mouseenter",enterFirstLineStyle);
bouton1.addEventListener("mouseleave",leaveFirstLineStyle);

var bouton2 = document.getElementById("secondLine");
bouton2.addEventListener("click",NewSecondLine);
bouton2.addEventListener("mouseenter",enterSecondLineStyle);
bouton2.addEventListener("mouseleave",leaveSecondLineStyle);

var bouton3 = document.getElementById("thirdLine");
bouton3.addEventListener("click",NewThirdLine);
bouton3.addEventListener("mouseenter",enterThirdLineStyle);
bouton3.addEventListener("mouseleave",leaveThirdLineStyle);
...
function enterFirstLineStyle(){
	firstLine.classList.replace("haiku","haikuOver");
}

function enterSecondLineStyle(){
	secondLine.classList.replace("haiku","haikuOver");
}

function enterThirdLineStyle(){
	thirdLine.classList.replace("haiku","haikuOver");
}

function leaveFirstLineStyle(){
	firstLine.classList.replace("haikuOver","haiku");
}

function leaveSecondLineStyle(){
	secondLine.classList.replace("haikuOver","haiku");
}

function leaveThirdLineStyle(){
	thirdLine.classList.replace("haikuOver","haiku");
}
